...
export default function Card({ imagePath, special, text }: CardProps) {
    return (
        <div className={`w-full sm:max-w-xs py-20 px-4 flex flex-col items-center justify-center text-center gap-3 ${special ? 'grad-2' : ' border-4 border-my '} rounded-xl sm:rounded-2xl`}>
