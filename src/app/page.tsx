...
export default function Home() {
  return (
    <>
      <header className="overflow-hidden relative w-full sm:h-screen flex items-center justify-center bg-my2 rounded-b-[42px] sm:rounded-b-[96px]">
        <div className="absolute top-0 left-0 px-4 sm:px-0 text-center border-b border-my/80 text-my/80 w-full py-3">
        ...
        <div className="w-full max-w-7xl flex flex-col sm:grid sm:grid-cols-2 px-4 sm:px-0 pt-24 sm:pt-0">
          <div className="flex flex-col items-start justify-center gap-2">
            <h4 className="text-white cinzel font-bold text-sm sm:text-base flex items-center gap-2">
            ...
            <p className="text-sm sm:text-base text-zinc-300 font-medium">Pare de comprar cursos, ouvir diquinhas no instagram e aprenda na prática a estruturar as vendas do seu negócio pelo Instagram!</p>
            <div className="flex flex-col gap-2 my-2">
              <p className="text-zinc-300 flex gap-2 font-medium text-sm sm:text-base">
            ...
            <a href="" className="font-bold sm:font-medium grad text-white rounded-lg py-3 sm:py-2 px-4 text-sm sm:text-base">Quero aumentar meu lucro mensal</a>
          </div>

          <div className="flex justify-end items-end pt-4 sm:pt-0">
            <img src="./images/bg.png" alt="Foto do Pedro Lucca" className="h-[86%]" />
          </div>
        </div>
      </header>
      <main className="pt-12 sm:pt-24 bg-zinc-100">
        <Section>
          <HeroFlex
            title="Você sente que está cada vez mais difícil de vender pelo Instagram?"
            imagePath="1"
          >
            <div className="flex flex-col gap-2 text-my2 font-medium mt-4 text-sm sm:text-base">
        ...
        <Section className="pt-12 sm:pt-24">
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-12 justify-center items-center px-4 sm:px-0">
            <Card
              imagePath="1"
              special={false}
        ...
        <Section className="px-4 sm:px-0 text-left sm:text-center py-16" classNameSection="my-12 sm:my-24 bg-my2 rounded-[42px] sm:rounded-[96px]">
          <div>
            ...
            <div className="flex justify-center w-full my-12">
              <img src="./images/graph.png" alt="Gráfico representando crescimento das vendas pela internet" className="w-full sm:max-w-lg" />
            </div>
          ...
          <div className="flex justify-center w-full my-12 sm:mt-20 sm:mb-28">
          ...
          <div className="flex flex-col mt-12">
            <p className="text-white/40 sm:text-xl font-medium mb-4">Hoje em dia, você só irá sobreviver vendendo na internet,</p>
        ...
        <Section className="">
          ...
          >
            <div className="font-medium flex flex-col gap-4 mt-4 text-sm sm:text-lg">
              <ul>
        ...
        <Section className="py-12 sm:my-12">
          <HeroFlex
            imagePath="1"
